  ...
  return (
    <>
      <div className={`selector-selected ${selected ? "visible" : ""}`} id="ultimaSel">
        ...
        <a className="ss-dl" href="/contact?datasheet=ultima.pdf#quote" data-hot>
          ...
          <tbody id="ultimaTbody">
            {rows.map((row) => (
              ...
              >
                ...
                <td>
                  <a className="st-dl" href="/contact?datasheet=ultima.pdf#quote" data-hot onClick={(e) => e.stopPropagation()}>
