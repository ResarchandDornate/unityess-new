  ...
  return (
    <>
      <div className={`selector-selected ${selected ? "visible" : ""}`} id="aquaSel">
        ...
        <a className="ss-dl" href="/contact?datasheet=aqua.pdf#quote" data-hot>
          ...
          <tbody id="aquaTbody">
            {rows.map((row) => (
              ...
              >
                ...
                <td>
                  <a className="st-dl" href="/contact?datasheet=aqua.pdf#quote" data-hot onClick={(e) => e.stopPropagation()}>
