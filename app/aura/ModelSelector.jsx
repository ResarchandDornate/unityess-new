  ...
  return (
    <>
      <div className={`selector-selected ${selected ? "visible" : ""}`} id="auraSel">
        ...
        <a className="ss-dl" href="/contact?datasheet=aura.pdf#quote" data-hot>
          ...
          <tbody id="auraTbody">
            {rows.map((row) => (
              ...
              >
                ...
                <td>
                  <a className="st-dl" href="/contact?datasheet=aura.pdf#quote" data-hot onClick={(e) => e.stopPropagation()}>
